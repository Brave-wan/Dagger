...
public class PriorityExecutor extends ThreadPoolExecutor {
    ...
    private static final Comparator<Runnable> FIFO = new Comparator<Runnable>() {
        ...
        public int compare(Runnable lhs, Runnable rhs) {
            if (lhs instanceof utils.PriorityRunnable && rhs instanceof utils.PriorityRunnable) {
                utils.PriorityRunnable lpr = ((utils.PriorityRunnable) lhs);
                utils.PriorityRunnable rpr = ((utils.PriorityRunnable) rhs);
    ...
    public void execute(Runnable runnable) {
        if (runnable instanceof utils.PriorityRunnable) {
            ((utils.PriorityRunnable) runnable).SEQ = SEQ_SEED.getAndIncrement();
        }
